<li class="list-group-item">
    <div class="media">
        ...
        <div class="media-body">
            ...
            <span class="badge badge-pill badge-success">收藏</span>
            {{
                $notification->data['is_collect'] ?
                "我觉得您{$notification->data['article']['type']}的这篇文章很不错！所以我收藏了您的这篇文章！👍" :
                "不好意思，我觉得您{$notification->data['article']['type']}的这篇文章可能没有那么好，所以我取消了收藏~~~"
            }}
