...
@section('content')
                    ...
                    <div class="card-footer p-2 text-center">
                        ...
                        @else
                            <div class="btn-group">
                                ...
                                <a href="#" class="btn btn-primary text-white" data-toggle="modal" data-target="#privateMessage">私信我</a>
    ...
    <div class="modal fade" id="privateMessage" tabindex="-1" role="dialog" aria-labelledby="privateMessageLabel"
        ...
        <div class="modal-dialog" role="document">
            <form action="{{ route('users.doPrivateMessage', $user) }}" method="post">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <textarea class="form-control" name="private_message" rows="5" placeholder="提示：技术问题请发问答帖，私信侵扰不礼貌。问答帖好处：1. 有助他人；2. 方便检索；3. 集思广益。也请勿回复此类私信。"></textarea>
                        </div>
                    </div>
